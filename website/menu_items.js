...
var MENU_ITEMS = [
	['Demos', null, null,
		['<span onMouseOver="myHint.show(0)" onMouseOut="myHint.hide()">Online Demo</span>', 'http://livedemo.pmease.com:8081/luntbuild/luntbuild-login.jsp', {'tw':'_blank'}],
		['Demo Movie', 'luntbuild-demo.html', {'tw':'_blank'}],
	...
	['Development', null, null,
		...
		['Development Wiki', 'http://www.javaforge.com/proj/doc.do?proj_id=70', null],

...
public class BlogNotifier extends TemplatedNotifier {
    ...
    private BlogConnection getBlogConnection(User user) {
        BlogConnection blog = new BlogConnection(
                ((IStringProperty)getUserLevelProperties().get(BLOG_TYPE)).getValue(user.getContacts()),
                ((IStringProperty)getUserLevelProperties().get(BLOG_URL)).getValue(user.getContacts()),
                ((IStringProperty)getUserLevelProperties().get(BLOG_ID)).getValue(user.getContacts()),
                ((IStringProperty)getUserLevelProperties().get(BLOG_USER)).getValue(user.getContacts()),
                ((IStringProperty)getUserLevelProperties().get(BLOG_PASSWORD)).getValue(user.getContacts()),
                ((IStringProperty)getUserLevelProperties().get(BLOG_CATEGORY)).getValue(user.getContacts())
                );
        return blog;
    }
    ...
    public List getUserLevelProperties() {
        List properties = getBloggerProperties();
        return properties;
    }

...
CREATE TABLE LB_USER(ID BIGINT NOT NULL PRIMARY KEY,NAME VARCHAR(255) NOT NULL,PASSWORD VARCHAR(255),CAN_CREATE_PROJECT INTEGER,CONTACTS BLOB,FULLNAME VARCHAR(255),CONSTRAINT SYS_CT_3 UNIQUE(NAME));
CREATE TABLE LB_PROJECT(ID BIGINT NOT NULL PRIMARY KEY,NAME VARCHAR(255) NOT NULL,DESCRIPTION VARCHAR(255),NOTIFIERS BLOB,VCS_LIST BLOB,BUILDER_LIST BLOB,VARIABLES BLOB,LOG_LEVEL INTEGER,CONSTRAINT SYS_CT_5 UNIQUE(NAME));

CREATE TABLE LB_ROLE(ID BIGINT NOT NULL PRIMARY KEY,NAME VARCHAR(255) NOT NULL,CONSTRAINT SYS_CT_1 UNIQUE(NAME)) ENGINE=InnoDB;
CREATE TABLE LB_ROLES_MAPPING(ID BIGINT NOT NULL PRIMARY KEY,FK_USER_ID BIGINT NOT NULL,FK_PROJECT_ID BIGINT NOT NULL,FK_ROLE_ID BIGINT NOT NULL) ENGINE=InnoDB;
CREATE TABLE LB_BUILD(ID BIGINT NOT NULL PRIMARY KEY,STATUS INTEGER,VERSION VARCHAR(255),LABEL_STRATEGY INTEGER,POSTBUILD_STRATEGY INTEGER,HAVE_LABEL_ON_HEAD INTEGER,BUILD_TYPE INTEGER,START_DATE TIMESTAMP,END_DATE TIMESTAMP NULL,REBUILD INTEGER,VCS_LIST BLOB,BUILDER_LIST BLOB,POSTBUILDER_LIST BLOB,FK_SCHEDULE_ID BIGINT NOT NULL) ENGINE=InnoDB;
CREATE TABLE LB_USER(ID BIGINT NOT NULL PRIMARY KEY,NAME VARCHAR(255) NOT NULL,PASSWORD VARCHAR(255),CAN_CREATE_PROJECT INTEGER,CONTACTS BLOB,FULLNAME VARCHAR(255),CONSTRAINT SYS_CT_3 UNIQUE(NAME)) ENGINE=InnoDB;
CREATE TABLE LB_PROJECT(ID BIGINT NOT NULL PRIMARY KEY,NAME VARCHAR(255) NOT NULL,DESCRIPTION VARCHAR(255),NOTIFIERS BLOB,VCS_LIST BLOB,BUILDER_LIST BLOB,VARIABLES BLOB,LOG_LEVEL INTEGER,CONSTRAINT SYS_CT_5 UNIQUE(NAME)) ENGINE=InnoDB;
CREATE TABLE LB_VCS_LOGIN(ID BIGINT NOT NULL PRIMARY KEY,FK_PROJECT_ID BIGINT NOT NULL,LOGIN VARCHAR(255),FK_USER_ID BIGINT NOT NULL,CONSTRAINT SYS_CT_7 UNIQUE(FK_PROJECT_ID,LOGIN)) ENGINE=InnoDB;
CREATE TABLE LB_SCHEDULE(ID BIGINT NOT NULL PRIMARY KEY,FK_PROJECT_ID BIGINT NOT NULL,SCHED_DISABLED INTEGER, NAME VARCHAR(255) NOT NULL,DESCRIPTION VARCHAR(255),NEXT_VERSION BLOB,NEXT_VERSION_VALUE BLOB,VARIABLES BLOB,QUARTZ_TRIGGER BLOB,DEPENDENT_SCHEDULE_IDS BLOB,BUILD_NECESSARY_CONDITION VARCHAR(255),ASSOCIATED_BUILDER_NAMES BLOB,ASSOCIATED_POSTBUILDER_NAMES BLOB,BUILD_TYPE INTEGER,LABEL_STRATEGY INTEGER,NOTIFY_STRATEGY INTEGER,POSTBUILD_STRATEGY INTEGER,TRIGGER_DEPENDENCY_STRATEGY INTEGER,STATUS INTEGER,STATUS_DATE TIMESTAMP,BUILD_CLEANUP_STRATEGY INTEGER,BUILD_CLEANUP_STRATEGY_DATA VARCHAR(255),WORKING_PATH VARCHAR(255),CONSTRAINT SYS_CT_9 UNIQUE(FK_PROJECT_ID,NAME)) ENGINE=InnoDB;
CREATE TABLE LB_NOTIFY_MAPPING(ID BIGINT NOT NULL PRIMARY KEY,FK_PROJECT_ID BIGINT NOT NULL,FK_USER_ID BIGINT NOT NULL) ENGINE=InnoDB;
CREATE TABLE LB_PROPERTY(NAME VARCHAR(255) NOT NULL PRIMARY KEY,VALUE VARCHAR(255)) ENGINE=InnoDB;

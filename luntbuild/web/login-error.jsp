    ...
    <tr bordercolor="0">
      ...
      <table width="100%" height="93%" border="0" cellpadding="6" cellspacing="0" bgcolor="#336699">
        <tr>
          ...
          <a href="http://luntbuild.sourceforge.net/" title="Goto Luntbuild's Home" >
    ...
    <tr align="center">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr bgcolor="#CCCCCC">
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr align="left">
                  <td class="centerTableDescriptionRow" scope="col">
                ...
                <tr class="dataTableTitleRow">
                  ...
                  <img src="images/error.gif" width="32" height="32" align="absmiddle">&nbsp;<span class="errorMsg">login failed !</span> <a HREF="/luntbuild/app">If you are not automatically redirected to login page, click here</a></td>
                  </tr>
                </table>
              </td>
            </tr>
        ...
        <tr bgcolor="#CCCCCC">
          ...
          by <a href="http://luntbuild.sourceforge.net/">Luntbuild</a> </td>
        </tr>
      </table>
      </td>
    </tr>

...
<meta http-equiv="Refresh" content="5; URL=/luntbuild/app"  />
    ...
    <tr align="center">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
            <tr bordercolor="#FFFFFF">
              ...
              <td width="100" bgcolor="#EEEEEE" class="tabSpace">
              &nbsp;</td>
            </tr>
          </table>
          </td>
        ...
        <tr bgcolor="#CCCCCC">
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr align="left">
                  <td colspan="7" class="centerTableDescriptionRow" scope="col" width="963">
                  <img src="images/guide.gif" width="58" height="45" border="0" class="centerTableDescriptionRowIcon"> 
                  Your credentials were not accepted by the underlying security 
                  provider, please validate your credentials and if the problem persists contact your luntbuild site admin.<br>
					&nbsp;</td>
                </tr>
                <tr class="dataTableTitleRow">
                  <td width="39" align="left" valign="top" scope="col">&nbsp;</td>
                  <td width="362" align="left" valign="top" scope="col">
                  <img src="images/error.gif" width="18" height="18" align="absmiddle">&nbsp;login failed !!</td>
                  <td width="9" align="left" valign="top" scope="col">
                  &nbsp;</td>
                  <td width="142" align="left" valign="top" scope="col">&nbsp;</td>
                  <td align="left" valign="top" scope="col" width="333">&nbsp;</td>
                  <td width="39" scope="col">&nbsp;</td>
                  <td width="39" scope="col">&nbsp;</td>
                </tr>
                <tr>
                  <td valign="top" class="dataTableRow1" align="left" width="39">&nbsp;</td>
                  <td valign="top" class="dataTableRow1" align="left" width="362">
                  &nbsp;</td>
                  <td valign="top" class="dataTableRow1" align="left" width="9">
                  &nbsp;</td>
                  <td valign="top" class="dataTableRow1" align="left" width="142">&nbsp;</td>
                  <td valign="top" class="dataTableRow1" align="left" width="333">&nbsp;</td>
                  <td valign="top" class="dataTableRow1" align="center" width="39">&nbsp;</td>
                  <td valign="top" class="dataTableRow1" align="center" width="39">&nbsp;</td>
                </tr>
                <tr>
                  <td valign="top" class="dataTableRow2" align="left" width="39">&nbsp;</td>
                  <td valign="top" class="dataTableRow2" align="left" width="362">
                  <a HREF="/luntbuild/app">If you are not automatically redirected click here to retry</a></td>
                  <td valign="top" class="dataTableRow2" align="left" width="9">
                  &nbsp;</td>
                  <td valign="top" class="dataTableRow2" align="left" width="142">&nbsp;</td>
                  <td valign="top" class="dataTableRow2" align="left" width="333">&nbsp;</td>
                  <td valign="top" class="dataTableRow2" align="center" width="39">&nbsp;</td>
                  <td valign="top" class="dataTableRow2" align="center" width="39">&nbsp;</td>
                </tr>
                </table>
              </td>
        ...
        <tr bgcolor="#CCCCCC">
          ...
          by <a href="http://www.luntsys.com/luntbuild/">luntbuild</a> </td>
        </tr>
      </table>
      </td>
    </tr>

...
public class SimpleP4OutputHandler extends P4HandlerAdapter {
    ...
    public SimpleP4OutputHandler(P4Base parent) {
        this(parent, Project.MSG_INFO);
    }

	public SimpleP4OutputHandler(P4Base parent, int outputPriority){
		this.parent = parent;
		this.outputPriority = outputPriority;
	}

	public void processStdout(String line){
		parent.log(line, outputPriority);
		process(line);
	}

	public void processStderr(String line){
		parent.log(line, Project.MSG_ERR);
		process(line);
	}
